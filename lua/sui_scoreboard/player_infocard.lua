...
function PANEL:PerformLayout()	
	...
	if not LocalPlayer():IsAdmin() then 
		...
		self.btnKick.DoClick = function() if self.Player:IsValid() then LocalPlayer():ConCommand( "exsto kick \"".. self.Player:Nick().. "\" \"Kicked By Administrator\"" ) end	end
		self.btnPBan.DoClick = function() if self.Player:IsValid() then LocalPlayer():ConCommand( "exsto ban \"".. self.Player:Nick().. "\" 0 \" Banned permanently by Administrator\"" ) end end 
		self.btnBan.DoClick = function() if self.Player:IsValid() then LocalPlayer():ConCommand( "exsto ban \"".. self.Player:Nick().. "\" 60 \" Banned for 1 hour by Administrator\"" ) end end		
	end
