...
function PANEL:UpdatePlayerData()
	...
	self.lblTeam:SetText( exsto.Ranks[self.Player:GetRank()].Name )

	self.lblHours:SetText( timeToString(self.Player:GetNWInt( "Time_Fixed" ) + (CurTime() - self.Player:GetNWInt( "Time_Join" ))))
...
function PANEL:Init()
	...
	self.imgAvatar:SetMouseInputEnabled( true )
...
function PANEL:PerformLayout()
	...
	self.lblHours:SetPos( self:GetWide() - COLUMN_SIZE * 9.5, 0 )
